        ...
        .then((foundUser) => {
            ...
            User.create({ email, password: hashedPassword })
                ...
                .then((createdUser) => {
                    ...
                    const payload = { email, _id, profilePic, fullName: '', location: '', age: 0, visitedRestaurants: [] };
    ...
    User.findOne({ email })
        ...
        .then((foundUser) => {
            ...
            if (passwordCorrect) {
                ...
                const { _id, email, fullName, location, age, profilePic, visitedRestaurants } = foundUser;

                // Create an object that will be set as the token payload
                const payload = { _id, email, fullName, location, age, profilePic, visitedRestaurants };
